...
class MainController(Node):
    def __init__(self):
        ...
        self.OBSTACLE_CHECK_INTERVAL = 0.1  # 降低检测频率到100ms
    ...
    def _check_wait_completion(self, obstacle_name):
        ...
        # 检查是否超时（防止无限等待）
        if elapsed_time > self.wait_duration + 2.0:  # 超时2秒
    ...
    def _attempt_detour(self, robot_x, robot_y, target_x, target_y, obstacle):
        ...
        # 设置导航成功检查
        self._setup_nav_success_check(detour_point)
    ...
    def _setup_nav_success_check(self, target_pos):
        ...
        estimated_time = distance / self.ROBOT_SPEED + 3.0  # 增加3秒缓冲
