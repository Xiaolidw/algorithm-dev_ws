                    ...
                    if (robot) {
                        ...
                        if (this->stop_distance <= 0.0) {
                            ...
                            if (!this->yielding_to_robot &&
                                ...
                                // "Passed" means crossing to the opposite side
                                // of the rail, not overtaking along the rail.
                                // Keep retreating in the latched direction until
                                // that crossing and distance hysteresis are both
                                // satisfied; only then may patrol reverse.
