...
class CubeObstacleMapNode(Node):
    ...
    def __init__(self):
        ...
        # world 中真实存在的 1m x 1m 固定石块。这里必须使用 world/state
        # 中的绝对坐标，不能直接抄 Untitled 模型内部的 link 局部坐标；
        # Untitled 父模型还有 (0.968798, -5.71233) 的平移。原始 PGM 将
        # 石块画成灰色(205)，按当前 map_server 阈值会被解释为空闲栅格，
        # 因此用下列 Gazebo 世界真值补成占用栅格。
        self.declare_parameter(
            'fixed_obstacles',
            ['stone_0:-10.7673:4.66367:0.55:0.55',
             'stone_1:-8.89993:-1.11285:0.55:0.55',
             'stone_2:1.73333:1.16425:0.55:0.55',
             'stone_3:15.5053:1.54302:0.55:0.55',
             'stone_4:-2.6955:-3.54292:0.55:0.55',
             'stone_5:6.42454:-3.66884:0.55:0.55',
             'stone_6:8.16205:-7.42608:0.55:0.55',
             'stone_7:1.57466:-7.73198:0.55:0.55',
             'stone_8:-13.437:-7.81538:0.55:0.55',
             'stone_9:-10.6671:-11.0531:0.55:0.55',
             'stone_10:12.6936:-10.8131:0.55:0.55',
             'stone_11:-2.50377:-14.1629:0.55:0.55',
             'stone_12:15.4715:-14.3041:0.55:0.55'])
